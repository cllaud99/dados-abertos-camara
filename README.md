...
## Análises Esperados dos Dashboards

Os dashboards devem fornecer várias visualizações gráficas e insights, incluindo:
...
1. **Deputado:**
   ...
   - Idade dos deputados (distribuição por faixa etária e média de idade).
   - Ranking de deputados por despesas.
...
3. **Estado:**
   - Total de gastos por estado.
   - Média de gastos por deputado no estado.
   - Número total de despesas por estado.
   - Número de deputados por estado.
   - Distribuição por gênero dos deputados no estado.
   - Distribuição educacional dos deputados no estado.

4. **Formação dos Deputados:**
   - Distribuição educacional dos deputados.

5. **Tipo de Despesa:**
   - Total de despesas por tipo.
   - Distribuição percentual de despesas por tipo.
   - Valor absoluto de despesas por tipo.
